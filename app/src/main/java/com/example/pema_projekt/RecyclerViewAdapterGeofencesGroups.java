...
public class RecyclerViewAdapterGeofencesGroups extends RecyclerView.Adapter<RecyclerViewAdapterGeofencesGroups.MyViewHolder>{
    ...
    public void deleteItem(int position){
        ...
        if(position <= mData.size()) {
            mReference = FirebaseDatabase.getInstance("https://randominder2-default-rtdb.europe-west1.firebasedatabase.app/").getReference("groups").child(groupName).child("geofence").child(mData.get(position).getName());
